...
test_blocksize_4096 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/01 - blocksize 4096.flac")
...
test_blocksize_4608 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/02 - blocksize 4608.flac")
...
test_blocksize_16 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/03 - blocksize 16.flac")
...
test_blocksize_192 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/04 - blocksize 192.flac")
...
test_blocksize_254 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/05 - blocksize 254.flac")
...
test_blocksize_512 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/06 - blocksize 512.flac")
...
test_blocksize_725 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/07 - blocksize 725.flac")
...
test_blocksize_1000 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/08 - blocksize 1000.flac")
...
test_blocksize_1937 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/09 - blocksize 1937.flac")
...
test_blocksize_2304 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/10 - blocksize 2304.flac")
...
test_partition_order_8 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/11 - partition order 8.flac")
...
test_qlp_precision_15_bit :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/12 - qlp precision 15 bit.flac")
...
test_qlp_precision_2_bit :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/13 - qlp precision 2 bit.flac")
...
wasted_bits :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/14 - wasted bits.flac")
...
only_verbatim_subframes :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/15 - only verbatim subframes.flac")
...
partition_order_8_containing_escaped_partitions :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/16 - partition order 8 containing escaped partitions.flac")
...
all_fixed_orders :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/17 - all fixed orders.flac")
...
precision_search :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/18 - precision search.flac")
...
samplerate_35467Hz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/19 - samplerate 35467Hz.flac")
...
samplerate_39kHz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/20 - samplerate 39kHz.flac")
...
samplerate_22050Hz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/21 - samplerate 22050Hz.flac")
...
_12_bit_per_sample :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/22 - 12 bit per sample.flac")
...
_8_bit_per_sample :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/23 - 8 bit per sample.flac")
...
high_resolution_audio_default_settings :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/28 - high resolution audio, default settings.flac")
...
high_resolution_audio_blocksize_16384 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/29 - high resolution audio, blocksize 16384.flac")
...
high_resolution_audio_blocksize_13456 :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/30 - high resolution audio, blocksize 13456.flac")
...
samplerate_192kHz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/33 - samplerate 192kHz.flac")
...
samplerate_192kHz_using_only_32nd_order_predictors :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/34 - samplerate 192kHz, using only 32nd order predictors.flac")
...
samplerate_134560Hz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/35 - samplerate 134560Hz.flac")
...
samplerate_384kHz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/36 - samplerate 384kHz.flac")
...
_20_bit_per_sample :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/37 - 20 bit per sample.flac")
...
_3_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/38 - 3 channels (3.0).flac")
...
_4_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/39 - 4 channels (4.0).flac")
...
_5_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/40 - 5 channels (5.0).flac")
...
_6_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/41 - 6 channels (5.1).flac")
...
_7_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/42 - 7 channels (6.1).flac")
...
_8_channels :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/43 - 8 channels (7.1).flac")
...
no_total_number_of_samples :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/45 - no total number of samples set.flac")
...
no_min_max_framesize :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/46 - no min-max framesize set.flac")
...
only_streaminfo :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/47 - only STREAMINFO.flac")
...
extreme_large_seektable :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/48 - Extremely large SEEKTABLE.flac")
...
extreme_large_padding :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/49 - Extremely large PADDING.flac")
...
extreme_large_picture :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/50 - Extremely large PICTURE.flac")
...
extreme_large_vorbiscomment :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/51 - Extremely large VORBISCOMMENT.flac")
...
extreme_large_application :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/52 - Extremely large APPLICATION.flac")
...
cuesheet_with_very_many_indexes :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/53 - CUESHEET with very many indexes.flac")
...
_1000x_repeating_vorbiscomment :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/54 - 1000x repeating VORBISCOMMENT.flac")
...
file_48_53_combined :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/55 - file 48-53 combined.flac")
...
jpg_picture :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/56 - JPG PICTURE.flac")
...
png_picture :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/57 - PNG PICTURE.flac")
...
gif_picture :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/58 - GIF PICTURE.flac")
...
avif_picture :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/59 - AVIF PICTURE.flac")
...
mono_audio :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/60 - mono audio.flac")
...
predictor_overflow_check_16_bit :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/61 - predictor overflow check, 16-bit.flac")
...
predictor_overflow_check_20_bit :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/62 - predictor overflow check, 20-bit.flac")
...
predictor_overflow_check_24_bit :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/63 - predictor overflow check, 24-bit.flac")
...
rice_partitions_with_escape_code_zero :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/subset/64 - rice partitions with escape code zero.flac")
...
uncommon_32_bit_per_sample :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/uncommon/05 - 32bps audio.flac")
...
uncommon_samplerate_768kHz :: proc(t: ^testing.T) {
    data, err := flac.load_from_file("flac-test-files/uncommon/06 - samplerate 768kHz.flac")
